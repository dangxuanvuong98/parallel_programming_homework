...
\section{Giới thiệu} 
\input{files/gioi-thieu.tex}

\section{Phương pháp lặp Successive Over Relaxation}
\input{files/phuong-phap-sor.tex}

\section{Song song hoá quá trình khuếch tán}
\input{files/song-song-hoa-qua-trinh-khuech-tan.tex}

\section{Công thức cập nhật cho từng trường hợp}
\input{files/cong-thuc-cap-nhat.tex}

\section{Công thức phát triển}
\input{files/cong-thuc-phat-trien.tex}

\section{Song song hoá quá trình phát triển}
\input{files/song-song-hoa-qua-trinh-phat-trien.tex}

\section{Sơ đồ luồng thuật toán}
\input{files/so-do-luong-thuat-toan.tex}

\section{Kết quả mô phỏng}
\input{files/ket-qua.tex}
